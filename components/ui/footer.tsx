...
interface FooterProps {
  className?: string; // This allows the className prop to be passed
}
  ...
  <a href="/">
    ...
    <div>
      ...
      <ul className="space-y-2">
        <li><a href="/blog" className="hover:text-[#5ce2e6] transition-colors">Blog</a></li>
        <li><a href="#benefits" className="hover:text-[#5ce2e6] transition-colors">Who are we ?</a></li>
        <li><a href="/get-access" className="hover:text-[#5ce2e6] transition-colors">Linux Cloud</a></li>
        {/* <li><a href="#mission" className="hover:text-[#5ce2e6] transition-colors">Contact Us</a></li> */ }
      </ul>
    </div>
    <div>
      <h4 className="text-xl font-semibold mb-4">Contact</h4>
      <p className="mb-2">Email: info@okalobe.com</p>
      <p>Phone: +123 456 7890</p>
    </div>
  </div>
  <div className="mt-12 pt-8 border-t border-gray-700 text-center">
    <p>&copy; 2025 NYOTAH. All rights reserved.</p>
  </div>
</div>
</footer>
