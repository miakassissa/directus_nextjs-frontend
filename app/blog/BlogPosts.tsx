...
export default function BlogPosts({ posts, totalCount, currentPage }: BlogPostsProps) {
  ...
  if (!posts) {
    return <p className="text-center">Error loading blog posts. Please try again.</p>
  }
